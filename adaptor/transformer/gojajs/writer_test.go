...
var (
	...
	writeTests = []struct {
		...
		},
		{
			...
			"function f(doc) { delete doc['data']['name']; return doc }",
		...
		},
		{
			...
			"function f(doc) { doc['data']['id']['$oid'] = '54a4420502a14b9641000001'; return doc }",
			message.From(ops.Insert, "collection", data.Data{"id": bsonID1, "name": "nick"}),
...
func TestWrite(t *testing.T) {
	for _, v := range writeTests {
		...
		w := Writer{}
		msg, err := w.transformOne(s.(*Session), v.in)
		if (err != nil) != v.err {
